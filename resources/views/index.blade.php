    ...
    <div class="popular-movies">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-16">
            @foreach ($popularmovies as $item)
                <div class="mt-8">
                    <a href="#">
                        <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$item['poster_path'] }}" alt="parasite" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                        ...
                        <div class="flex item-center text-gray-400 text-sm mt-1">
                            ...
                            <span class="ml-1"> {{ $item['vote_average'] * 10 }} %</span>
